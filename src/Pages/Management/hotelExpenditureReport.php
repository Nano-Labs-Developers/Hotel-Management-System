                            ...
                            <div class="col-lg-6 col-7">
                                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Generate Hotel Expenditure Report</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class=" col ">
                        <div class="card">
                            <div class="card-header bg-transparent">
                                <h3 class="mb-0">Hotel Expenditure Report</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="col-xl-8 order-xl-1">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <form name="addItemForm" action="reports/hotel_expenditure_report.php" method="post">
                                                        <div class="pl-lg-4">
                                                            <div class="row">
                                                                <?php
