...
<?php
    if (isset($_POST['submit'])){
        ...
        if ($manager->checkEmailExists($_POST['email'], $userid)) {
            echo'
                <script>
                    location.replace("settings.php?emailexists=true");
                </script>
            ';
        } else if ($manager->checkUsernameExists($username, $userid)) {
            echo'
                <script>
            ...
            $manager->updateAccount($firstName, $lastName, $email, $username, $password, $userid);
        }
    }
