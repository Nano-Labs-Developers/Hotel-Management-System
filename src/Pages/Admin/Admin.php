...
<html>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card card-stats">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0">HOTELS</h5>
                                        ...
                                        <p class="mt-3 mb-0 text-sm">
                                            <span class="text-nowrap">Total hotels</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span class="h2 font-weight-bold mb-0">435</span>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <p class="mt-3 mb-0 text-sm">
                                        <span class="text-nowrap">Hotel staff count</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span class="h2 font-weight-bold mb-0">289</span>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card card-stats">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <h5 class="card-title text-uppercase text-muted mb-0">System Users</h5>
                                            <span class="h2 font-weight-bold mb-0">170</span>
                                        </div>
                                        <div class="col-auto">
                                            <div class="icon icon-shape bg-gradient-info text-white rounded-circle shadow">
                                    ...
                                    <p class="mt-3 mb-0 text-sm">
                                        <span class="text-nowrap">All hotels system users count</span>
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <script src="/src/Lib/vendor/chart.js/dist/Chart.min.js"></script>
    <script src="/src/Lib/vendor/chart.js/dist/Chart.extension.js"></script>
