                            ...
                            <div class="card-body">
                                <div class="row icon-examples">
                                    <div class="col-xl-4 order-xl-1">
                                        <div class="card">
                                            <a href="/hotelbar/liquor/addliquor" style="color: white" type="button" class="btn btn-success"><i class="fas fa-user-plus"></i>Add New Item</a>
                                        </div>
                                    </div>
                                                    ...
                                                    <tbody class="list">
                                                        <?php
                                                            ...
                                                            foreach ($items as $item) {
                                                                $button = '<a href="editItem.php?id='. $item['id'] .'" type="button" class="btn btn-warning btn-sm"><i class="fas fa-user-edit"></i> UPDATE</a>';
