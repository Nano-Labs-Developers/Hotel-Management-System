    ...
    <body>
        ...
        <script>
            function validateForm() {
                ...
                var x = document.forms["accountUpdateForm"]["email"].value;
                var atpos = x.indexOf("@");
...
<?php
    if (isset($_POST['submit'])){
        ...
        if ($receptionist->checkEmailExists($_POST['email'], $userid)) {
            echo'
                <script>
                    location.replace("settings.php?emailexists=true");
                </script>
            ';
        } else if ($receptionist->checkUsernameExists($username, $userid)) {
            echo'
                <script>
            ...
            $receptionist->updateAccount($firstName, $lastName, $email, $username, $password, $userid);
        }
    }
