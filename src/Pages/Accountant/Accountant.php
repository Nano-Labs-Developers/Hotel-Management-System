<?php
    ...
    if ($_SESSION['user_secret'] != 'efc6880119dd022043c5fa395d33598c66ec79ff') {
        header("location: /login");
    }
...
<html>
    ...
    <body>
        <?php include "../../Components/Accountant/NavbarSide.php" ?>

        <div class="main-content" id="panel">
            <?php include "../../Components/Accountant/Navbar.php" ?>
